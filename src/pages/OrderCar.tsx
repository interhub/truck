...
import {Rating, AirbnbRating, Button, Tooltip, Input} from 'react-native-elements';
import MyIcon from './../comps/MyIcon';
import TabsCar from './tabs_car/TabsCar';
import getSum from '../comps/getSum';

const OrderCar = (props: any) => {
  ...
  return <View style={styles.back}>
    ...
    {tab !== 0 && <TabsCar tab={tab} setTab={setTab}/>}
...
const ConnectOrderCar = connect(mstp, mdtp)(OrderCar);

export default ConnectOrderCar;
